...
async def test_R6_revoke_then_add_back_all_channels_updates_metadata(
    ...
    # Current behavior: access_policy remains REVOKED; re-share doesn't un-revoke implicitly
...
async def test_R7_revoke_then_add_back_subset_of_channels(
    ...
    assert share_after.access_policy == ShareAccessPolicy.REVOKED  # current behavior
